...
On Windows:
>  git clone https://github.com/erengorgu/glistzbin-win64.git

On MacOS:
>  git clone https://github.com/erengorgu/glistzbin-macos.git

On Linux:
>  git clone https://github.com/erengorgu/glistzbin-linux.git
